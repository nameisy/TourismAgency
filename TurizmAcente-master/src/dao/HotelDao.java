...
public class HotelDao {
    ...
    public int saveAndGetHotelId(Hotel hotel) {
        ...
        try {
            // Check if there is a record in the database with the same e-mail address.
        ...
        return -1; // Returns -1 on error or failed insertion
    }

    // Method to check if there is a hotel registered with the given e-mail address in the database.
    private boolean isEmailExists(String email) throws SQLException {
        ...
        try (PreparedStatement pr = con.prepareStatement(query)) {
            ...
            if (rs.next()) {
                ...
                return count > 0; // If count is greater than 0, there is a hotel registered with the e-mail address.
            }
        }
        return false;
    }
