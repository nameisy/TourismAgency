...
// overnight fee fee update events.
       ...
       /* fld_adult_price.addKeyListener(new KeyAdapter() {
            @Override
        ...
        fld_child_price.addKeyListener(new KeyAdapter() {
            @Override
            public void keyReleased(KeyEvent e) {
                roomPriceCalcul();
            }
    ...
    public int roomPriceCalcul(){
      ...
      /*  // Check the adult price.
        ...
        adultNum=(Integer)cmb_adult_num.getSelectedItem();
        childNum= (Integer)cmb_child_num.getSelectedItem();
*/
