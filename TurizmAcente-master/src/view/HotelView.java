...
// room serach
        btn_room_sh.addActionListener(e -> {
            if(!fld_chec_in.getText().isEmpty() && !fld_check_out.getText().isEmpty()) {
                if (Helper.isValidDate(fld_chec_in.getText(), ("dd-MM-yyyy")) && Helper.isValidDate(fld_check_out.getText(), ("dd-MM-yyyy"))) {
