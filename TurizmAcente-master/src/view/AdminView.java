...
public class AdminView extends Layout {
    ...
    public AdminView(User user) {
        ...
        this.lbl_welcome.setText(" Have a Good Day, "  +
                this.user.getRole() + ". Welcome to Patika Tour Panel.");
    ...
    public void loadAdminPanelComponent() {
        ...
        btn_rol_search.addActionListener(e -> {
               ...
               /* ComboItem selectedBrand = (ComboItem) this.cmb_role_list.getSelectedItem();
                int plateId = 0;
