...
public class SeasonDao {
    ...
    /*  public ArrayList<Season> findAll(int hotelId) {
          ...
          String query = "SELECT season_id, start_date, end_date, hotel_id, season_type FROM hotel_seasons WHERE hotel_id = ? ORDER BY season_id ASC";
    ...
    // Method to create Season object from ResultSet
   /* private Season match(ResultSet rs) throws SQLException {
        ...
        season.setSeason_start(rs.getObject("start_date", LocalDate.class));
        season.setSeason_end(rs.getObject("end_date", LocalDate.class));
