...
public class ReservationAdd extends Layout {
    ...
    private JTextField fld_pansiyon_type;
    ...
    public ReservationAdd(Room selectroom,Property selectProperty) {
       this.hotelManager = new HotelManager();
        ...
        String hotelPansType = typeManager.getByTypeId(this.room.getHotelTypeId());
        fld_pansiyon_type.setText(hotelPansType);

        String roomType =this.room.getRoomType();
        fld_room_type.setText(roomType);
